...
def extract_information(root='./data', net=['cif10'], dest='./data/detection', run_nr=[1], csv_filename='eval.csv', layers=True, ATTACKS='attacks', DETECTION='detection'):
...
# extract_information(root='./data', net=['cif10'], dest='./data/data_transfer', run_nr=[1], csv_filename='attack_transfer_cif10.csv', layers=False,  ATTACKS='attacks', DETECTION='data_transfer')
# extract_information(root='./data', net=['imagenet32'], dest='./data/data_transfer', run_nr=[1], csv_filename='attack_transfer_imagenet32.csv', layers=False,  ATTACKS='attacks', DETECTION='data_transfer')
# extract_information(root='./data', net=['celebaHQ32'], dest='./data/data_transfer', run_nr=[1], csv_filename='attack_transfer_celebaHQ32.csv', layers=False,  ATTACKS='attacks', DETECTION='data_transfer')
# extract_information(root='./data', net=['imagenet64'], dest='./data/data_transfer', run_nr=[1], csv_filename='attack_transfer_imagenet64.csv', layers=False,  ATTACKS='attacks', DETECTION='data_transfer')
extract_information(root='./data', net=['celebaHQ64'], dest='./data/data_transfer', run_nr=[1], csv_filename='attack_transfer_celebaHQ64.csv', layers=False,  ATTACKS='attacks', DETECTION='data_transfer')
# extract_information(root='./data', net=['imagenet128'], dest='./data/data_transfer', run_nr=[1], csv_filename='attack_transfer_imagenet128.csv', layers=False,  ATTACKS='attacks', DETECTION='data_transfer')
# extract_information(root='./data', net=['celebaHQ128'], dest='./data/data_transfer', run_nr=[1], csv_filename='attack_transfer_celebaHQ128.csv', layers=False,  ATTACKS='attacks', DETECTION='data_transfer')